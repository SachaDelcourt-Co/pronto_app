  ...
  fr: {
    translation: {
      ...
      login: {
        ...
        selectMotivations: 'Sélectionnez vos motivations (max. 2)',
        ...
        networkErrorMessage: 'Problème de connexion réseau. Veuillez vérifier votre connexion internet.',
        iosNetworkTip: 'Sur iOS, essayez de vous connecter en utilisant un email se terminant par @test.com pour le mode développement.',
        retry: 'Réessayer',
        cancel: 'Annuler'
      },
      home: {
  ...
  en: {
    translation: {
      ...
      login: {
        ...
        networkErrorMessage: 'Network connection problem. Please check your internet connection.',
        iosNetworkTip: 'On iOS, try logging in with an email ending in @test.com for development mode.',
        retry: 'Retry',
        cancel: 'Cancel'
      },
      home: {
